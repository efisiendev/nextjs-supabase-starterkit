...
export function articleToDbInsert(article: Article): Database['public']['Tables']['articles']['Insert'] {
  return {
    // id will be auto-generated by database (UUID)
    title: article.title,
    slug: article.slug,
...
export function eventToDbInsert(event: Event): Database['public']['Tables']['events']['Insert'] {
  return {
    // id will be auto-generated by database (UUID)
    title: event.title,
    slug: event.slug,
