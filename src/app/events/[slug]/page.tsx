            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="flex items-center gap-2 mb-4">
                  <span className={`px-4 py-2 ${statusColors[event.status]} font-medium rounded-lg`}>
                ...
                <div className="prose prose-lg max-w-none mb-8">
                  ...
                  {event.content.split('\n\n').map((paragraph, index) => (
                    <div key={index} className="mb-4 text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: paragraph.replace(/\*\*(.*?)\*\*/g, '<strong>$1</strong>').replace(/\n/g, '<br />') }} />
                  ))}
                </div>
